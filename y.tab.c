...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from 6_calculator.y  */
...
#endif
/* DEFAULT STYPE*/
      /* We used to use `unsigned long' as YY_Calculator_STYPE on MSDOS,
...
#define YY_Calculator_ERROR yyerror
 ...
 #ifndef YY_USE_CLASS
  #ifdef YYPARSE_PARAM
   #define YY_Calculator_PARSE_PARAM void* YYPARSE_PARAM 
  #else
   #ifndef __STDC__
    #ifndef __cplusplus
...
#  ifndef YYPURE
#    define YYPURE YY_Calculator_PURE
#  endif
#endif
...
#ifndef YY_Calculator_ERROR_VERBOSE
 #ifdef YYERROR_VERBOSE
  #define YY_Calculator_ERROR_VERBOSE YYERROR_VERBOSE
 #endif
#endif

#ifndef YY_Calculator_LSP_NEEDED
#  ifdef YYLSP_NEEDED
#    define YY_Calculator_LSP_NEEDED YYLSP_NEEDED
#  endif
#endif
...
#endif
#ifndef YY_Calculator_CONSTRUCTOR_CODE
#define YY_Calculator_CONSTRUCTOR_CODE
#endif
#ifndef YY_Calculator_CONSTRUCTOR_INIT
#define YY_Calculator_CONSTRUCTOR_INIT
#endif
...
const int YY_Calculator_CLASS::NUMBER=258;
const int YY_Calculator_CLASS::ALPHA=259;


#line 341 "/usr/share/bison++/bison.cc"
 /* const YY_Calculator_CLASS::token */
#endif
/*apres const  */
YY_Calculator_CLASS::YY_Calculator_CLASS(YY_Calculator_CONSTRUCTOR_PARAM) YY_Calculator_CONSTRUCTOR_INIT
{
#if YY_Calculator_DEBUG != 0
YY_Calculator_DEBUG_FLAG=0;
#endif
YY_Calculator_CONSTRUCTOR_CODE;
};
#endif
...
static const short yyprhs[] = {     0,
     0,     3,     7,    11,    15,    19,    23,    26,    28
};

static const short yyrhs[] = {    13,
    11,     0,    13,     7,    13,     0,    13,     8,    13,     0,
     9,    13,    10,     0,    13,     5,    13,     0,    13,     6,
    13,     0,     6,    13,     0,     3,     0,     4,     0
};

#endif

#if (YY_Calculator_DEBUG != 0) || defined(YY_Calculator_ERROR_VERBOSE) 
static const short yyrline[] = { 0,
    15,    21,    22,    30,    31,    32,    33,    34,    35
};

static const char * const yytname[] = {   "$","error","$illegal.","NUMBER","ALPHA",
"'+'","'-'","'*'","'/'","'('","')'","'\\n'","grammar","expr",""
};
#endif
...
-32768,-32768,    10,    10,     4,-32768,    15,    10,    10,    10,
    10,-32768,-32768,-32768,-32768,-32768,-32768,     2,     3,-32768
};
...
static const short yytable[] = {     6,
     7,    19,    20,     0,    14,    15,    16,    17,     8,     9,
    10,    11,     1,     2,    12,     3,     0,     0,     4,     8,
     9,    10,    11,     0,    13
};

static const short yycheck[] = {     3,
     4,     0,     0,    -1,     8,     9,    10,    11,     5,     6,
     7,     8,     3,     4,    11,     6,    -1,    -1,     9,     5,
     6,     7,     8,    -1,    10
};
...
#define yyclearin       (YY_Calculator_CHAR = YYEMPTY)
#define YYEMPTY         -2
#define YYEOF           0
...
do                                                              \
  if (YY_Calculator_CHAR == YYEMPTY && yylen == 1)                               \
    { YY_Calculator_CHAR = (token), YY_Calculator_LVAL = (value);                 \
      yychar1 = YYTRANSLATE (YY_Calculator_CHAR);                                \
      YYPOPSTACK;                                               \
      YYGOTO(yybackup);                                            \
    }                                                           \
  else                                                          \
    { YY_Calculator_ERROR ("syntax error: cannot back up"); YYERROR; }   \
while (0)
...
#ifndef YY_Calculator_PURE
/* UNPURE */
#define YYLEX           YY_Calculator_LEX()
#ifndef YY_USE_CLASS
/* If nonreentrant, and not class , generate the variables here */
int     YY_Calculator_CHAR;                      /*  the lookahead symbol        */
YY_Calculator_STYPE      YY_Calculator_LVAL;              /*  the semantic value of the */
				/*  lookahead symbol    */
int YY_Calculator_NERRS;                 /*  number of parse errors so far */
#ifdef YY_Calculator_LSP_NEEDED
YY_Calculator_LTYPE YY_Calculator_LLOC;   /*  location data for the lookahead     */
			/*  symbol                              */
#endif
#endif
...
/* PURE */
#ifdef YY_Calculator_LSP_NEEDED
#define YYLEX           YY_Calculator_LEX(&YY_Calculator_LVAL, &YY_Calculator_LLOC)
#else
#define YYLEX           YY_Calculator_LEX(&YY_Calculator_LVAL)
#endif
#endif
#ifndef YY_USE_CLASS
#if YY_Calculator_DEBUG != 0
...
int
 ...
 YY_Calculator_CLASS::
#endif
     YY_Calculator_PARSE(YY_Calculator_PARSE_PARAM)
#ifndef __STDC__
#ifndef __cplusplus
#ifndef YY_USE_CLASS
/* parameter definition without protypes */
YY_Calculator_PARSE_PARAM_DEF
#endif
#endif
#endif
{
  ...
  register YY_Calculator_STYPE *yyvsp;
  int yyerrstatus;      /*  number of tokens to shift before error messages enabled */
  int yychar1=0;          /*  lookahead token as an internal (translated) token number */

  short yyssa[YYINITDEPTH];     /*  the state stack                     */
  YY_Calculator_STYPE yyvsa[YYINITDEPTH];        /*  the semantic value stack            */

  short *yyss = yyssa;          /*  refer to the stacks thru separate pointers */
  YY_Calculator_STYPE *yyvs = yyvsa;     /*  to allow yyoverflow to reallocate them elsewhere */

#ifdef YY_Calculator_LSP_NEEDED
  YY_Calculator_LTYPE yylsa[YYINITDEPTH];        /*  the location stack                  */
  YY_Calculator_LTYPE *yyls = yylsa;
  YY_Calculator_LTYPE *yylsp;
...
#define YYPOPSTACK   (yyvsp--, yyssp--)
  ...
  YY_Calculator_STYPE yyval;             /*  the variable used to return         */
...
#if YY_Calculator_DEBUG != 0
  if (YY_Calculator_DEBUG_FLAG)
    fprintf(stderr, "Starting parse\n");
#endif
  yystate = 0;
  yyerrstatus = 0;
  YY_Calculator_NERRS = 0;
  YY_Calculator_CHAR = YYEMPTY;          /* Cause a token to be read.  */
  ...
  if (yyssp >= yyss + yystacksize - 1)
    {
      ...
      YY_Calculator_STYPE *yyvs1 = yyvs;
      short *yyss1 = yyss;
#ifdef YY_Calculator_LSP_NEEDED
      YY_Calculator_LTYPE *yyls1 = yyls;
#endif
	...
	{
	  YY_Calculator_ERROR("parser stack overflow");
	  __ALLOCA_return(2);
	}
      yystacksize *= 2;
      if (yystacksize > YYMAXDEPTH)
	yystacksize = YYMAXDEPTH;
      ...
      yyvs = (YY_Calculator_STYPE *) __ALLOCA_alloca (yystacksize * sizeof (*yyvsp));
      __yy_bcopy ((char *)yyvs1, (char *)yyvs, size * sizeof (*yyvsp));
      __ALLOCA_free(yyvs1,yyvsa);
#ifdef YY_Calculator_LSP_NEEDED
      yyls = (YY_Calculator_LTYPE *) __ALLOCA_alloca (yystacksize * sizeof (*yylsp));
...
/* YYLABEL(yyresume) */
  ...
  if (YY_Calculator_CHAR == YYEMPTY)
    {
#if YY_Calculator_DEBUG != 0
      if (YY_Calculator_DEBUG_FLAG)
	fprintf(stderr, "Reading a token: ");
#endif
      YY_Calculator_CHAR = YYLEX;
    }

  /* Convert token to internal form (in yychar1) for indexing tables with */

  if (YY_Calculator_CHAR <= 0)           /* This means end of input. */
    {
      yychar1 = 0;
      YY_Calculator_CHAR = YYEOF;                /* Don't call YYLEX any more */
  ...
  else
    {
      ...
      if (YY_Calculator_DEBUG_FLAG)
	{
	  fprintf (stderr, "Next token is %d (%s", YY_Calculator_CHAR, yytname[yychar1]);
	  /* Give the individual parser a way to print the precise meaning
	     of a token, for further debugging info.  */
#ifdef YYPRINT
	  YYPRINT (stderr, YY_Calculator_CHAR, YY_Calculator_LVAL);
#endif
	  fprintf (stderr, ")\n");
	}
#endif
...
#if YY_Calculator_DEBUG != 0
  if (YY_Calculator_DEBUG_FLAG)
    fprintf(stderr, "Shifting token %d (%s), ", YY_Calculator_CHAR, yytname[yychar1]);
#endif

  /* Discard the token being shifted unless it is eof.  */
  if (YY_Calculator_CHAR != YYEOF)
    YY_Calculator_CHAR = YYEMPTY;

  *++yyvsp = YY_Calculator_LVAL;
#ifdef YY_Calculator_LSP_NEEDED
  *++yylsp = YY_Calculator_LLOC;
#endif
...
;
    break;}
case 2:
#line 21 "6_calculator.y"
{yyval = yyvsp[-2] * yyvsp[0];;
    break;}
case 3:
#line 22 "6_calculator.y"
{
        if (yyvsp[0] == 0) {
   ...
   ;
    break;}
case 4:
#line 30 "6_calculator.y"
{yyval = yyvsp[-1];;
    break;}
case 5:
#line 31 "6_calculator.y"
{yyval = yyvsp[-2] + yyvsp[0];;
    break;}
case 6:
#line 32 "6_calculator.y"
{yyval = yyvsp[-2] - yyvsp[0];;
    break;}
case 7:
#line 33 "6_calculator.y"
{yyval = -yyvsp[0];;
    break;}
case 8:
#line 34 "6_calculator.y"
{yyval = yyvsp[0];;
    break;}
case 9:
#line 35 "6_calculator.y"
...
#line 839 "/usr/share/bison++/bison.cc"
  ...
  *++yyvsp = yyval;
  ...
  if (yylen == 0)
    {
      yylsp->first_line = YY_Calculator_LLOC.first_line;
      yylsp->first_column = YY_Calculator_LLOC.first_column;
...
#ifdef YY_Calculator_ERROR_VERBOSE
      yyn = yypact[yystate];
      ...
      if (yyn > YYFLAG && yyn < YYLAST)
	{
	  ...
	  if (msg != 0)
	      ...
	      if (count < 5)
		{
	      ...
	      YY_Calculator_ERROR(msg);
	      free(msg);
	    }
	  else
	    YY_Calculator_ERROR ("parse error; also virtual memory exceeded");
	}
      else
#endif /* YY_Calculator_ERROR_VERBOSE */
	YY_Calculator_ERROR("parse error");
    }
...
#if YY_Calculator_DEBUG != 0
      if (YY_Calculator_DEBUG_FLAG)
	fprintf(stderr, "Discarding token %d (%s).\n", YY_Calculator_CHAR, yytname[yychar1]);
#endif
